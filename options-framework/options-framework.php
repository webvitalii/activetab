...
function optionsframework_menu_settings() {
	...
	$menu = array(
		'page_title' => __( 'Theme Options', 'activetab' ),
		'menu_title' => __( 'Theme Options', 'activetab' ),
...
function optionsframework_load_scripts( $hook ) {
	...
	if ( !wp_script_is( 'wp-color-picker', 'registered' ) ) {
		...
		$colorpicker_l10n = array(
			'clear' => __( 'Clear', 'activetab' ),
			'defaultString' => __( 'Default', 'activetab' ),
			'pick' => __( 'Select Color', 'activetab' )
		);
...
function optionsframework_validate( $input ) {
	...
	if ( isset( $_POST['reset'] ) ) {
		add_settings_error( 'options-framework', 'restore_defaults', __( 'Default options restored.', 'activetab' ), 'updated fade' );
...
function optionsframework_save_options_notice() {
	add_settings_error( 'options-framework', 'save_options', __( 'Options saved.', 'activetab' ), 'updated fade' );
}
...
function optionsframework_adminbar() {
	...
	$wp_admin_bar->add_menu( array(
		'parent' => 'appearance',
		'id' => 'of_theme_options',
		'title' => __( 'Theme Options', 'activetab' ),
