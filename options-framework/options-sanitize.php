...
function of_recognized_background_repeat() {
	$default = array(
		'no-repeat' => __( 'No Repeat', 'activetab' ),
		'repeat-x'  => __( 'Repeat Horizontally', 'activetab' ),
		'repeat-y'  => __( 'Repeat Vertically', 'activetab' ),
		'repeat'    => __( 'Repeat All', 'activetab' ),
		);
...
function of_recognized_background_position() {
	$default = array(
		'top left'      => __( 'Top Left', 'activetab' ),
		'top center'    => __( 'Top Center', 'activetab' ),
		'top right'     => __( 'Top Right', 'activetab' ),
		'center left'   => __( 'Middle Left', 'activetab' ),
		'center center' => __( 'Middle Center', 'activetab' ),
		'center right'  => __( 'Middle Right', 'activetab' ),
		'bottom left'   => __( 'Bottom Left', 'activetab' ),
		'bottom center' => __( 'Bottom Center', 'activetab' ),
		'bottom right'  => __( 'Bottom Right', 'activetab')
		);
...
function of_recognized_background_attachment() {
	$default = array(
		'scroll' => __( 'Scroll Normally', 'activetab' ),
		'fixed'  => __( 'Fixed in Place', 'activetab')
		);
...
function of_recognized_font_styles() {
	$default = array(
		'normal'      => __( 'Normal', 'activetab' ),
		'italic'      => __( 'Italic', 'activetab' ),
		'bold'        => __( 'Bold', 'activetab' ),
		'bold italic' => __( 'Bold Italic', 'activetab' )
	);
