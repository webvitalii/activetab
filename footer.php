	...
	<div class="row">
		...
		<div class="col-sm-4">
			<div class="site-footer-right text-right">
				...
				<a href="http://wordpress.org/" title="<?php _e( 'WordPress CMS', 'activetab' ); ?>" target="_blank"><i class="dashicons dashicons-wordpress"></i> <span><?php _e( 'WordPress', 'activetab' ); ?></span></a>
				<?php _e( '&', 'activetab' ); ?>
				<a href="http://web-profile.net/wordpress/themes/activetab/" title="<?php _e( 'Activetab theme', 'activetab' ); ?>" target="_blank"><i class="dashicons dashicons-layout"></i> <span><?php _e( 'Activetab', 'activetab' ); ?></span></a>
