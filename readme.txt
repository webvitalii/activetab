...
* replaced FontAwesome with Dashicons
* clean up and bug fixing

= 2.2 - 2015-01-20 =
* fixing validator errors (remove pubdate attr, remove rel attr, remove duplicate ids)

= 2.1 - 2015-01-18 =
* added 'title-tag' feature
...
* replace '-lg-' with '-sm-' inside of php templates for hiding sidebar on small screens

= 1.5 - 2014-05-27 =
* default form controls styles update
* removed link to bootstrap.css.map

= 1.4 - 2014-04-02 =
* updated Bootstrap v.3.1.1

= 1.3 - 2014-02-07 =
* updated Bootstrap v.3.1.0
* moved changelog to changelog.txt
* moved text files to txt folder
